<template>
    <div class="container">
        <div class="alert alert-info">
            ...
            don't accept collection ids. That's where this resolver comes in. Just enter the collection id and see what happens <span role="img" aria-label="cat and pc">🐱‍💻</span><br/>
            <br/>
