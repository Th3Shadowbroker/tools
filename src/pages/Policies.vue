<template>
    <div class="container">
        ...
        <p>This website does not save any personal-information.</p>

        <h2>Cookie Policy for Th3Shadowbroker's Tools</h2>

        <p>This is the Cookie Policy for Th3Shadowbroker's Tools, accessible from https://tools.th3shadowbroker.org</p>
        ...
        <p>Hopefully that has clarified things for you and as was previously mentioned if there is something that you
            ...
            with one of the features you use on our site. This Cookies Policy was created with the help of the <a
        ...
        <ul>
            <li>Email: webmaster@m4taiori.de</li>
            <li>By visiting this link: https://m4taiori.io/#contact</li>
        </ul>
    </div>
</template>
